...
const searchSchema = z.object({
  q: fallback(z.string(), "").default("").optional(),
  origin: fallback(z.string(), "all").default("all").optional(),
  destination: fallback(z.string(), "all").default("all").optional(),
  loadType: fallback(z.string(), "all").default("all").optional(),
  equipment: fallback(z.string(), "all").default("all").optional(),
  pickup: fallback(z.string(), "").default("").optional(),
  minRate: fallback(z.number(), 0).default(0).optional(),
  maxDistance: fallback(z.number(), 2000).default(2000).optional(),
  border: fallback(z.boolean(), false).default(false).optional(),
  zimra: fallback(z.boolean(), false).default(false).optional(),
  urgent: fallback(z.boolean(), false).default(false).optional(),
  minWeight: fallback(z.number(), 0).default(0).optional(),
  maxWeight: fallback(z.number(), 40).default(40).optional(),
  payment: fallback(z.string(), "all").default("all").optional(),
  sort: fallback(z.enum(["newest", "rate_high", "rate_low", "rate_per_km", "distance"]), "newest").default("newest").optional(),
